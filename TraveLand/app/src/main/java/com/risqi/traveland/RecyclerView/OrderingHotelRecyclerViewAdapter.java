...
public class OrderingHotelRecyclerViewAdapter  extends RecyclerView.Adapter<OrderingHotelRecyclerViewAdapter.NameViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull OrderingHotelRecyclerViewAdapter.NameViewHolder holder, int position) {
...
//        bintangRecyclerViewAdapter.notifyDataSetChanged();
    ...
    public OrderingHotelRecyclerViewAdapter(Context context, List<String> datakomentar) {
