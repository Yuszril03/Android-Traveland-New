package com.risqi.traveland.TempData;

public class TempDataCustomer {
    String NikCustomer,KataSandi,AlamatCustomer,EmailCustomer,NamaCustomer,TanggalBuat,TanggalLahirCustomer,TanggalUpdate,TelefonCustomer,FotoCustomer;
    int Gender,StatusCustomer;

    public  TempDataCustomer(){
    ...
    public void setNikCustomer(String nikCustomer) {
