...
public class KomentarHotelRecyclerViewAdapter extends RecyclerView.Adapter<KomentarHotelRecyclerViewAdapter.NameViewHolder> {
    ...
    @NonNull
    @Override
    public KomentarHotelRecyclerViewAdapter.NameViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.item_list_komentar, parent, false);
        return new KomentarHotelRecyclerViewAdapter.NameViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull KomentarHotelRecyclerViewAdapter.NameViewHolder holder, int position) {

        TransactionHotel transactionWIisatas = datakomentar.get(position);
...
//            holder.bgkomeMitra.setMaxHeight(0);
    ...
    private List<TransactionHotel> datakomentar;
    ...
    public KomentarHotelRecyclerViewAdapter(Context context, List<TransactionHotel> datakomentar) {
